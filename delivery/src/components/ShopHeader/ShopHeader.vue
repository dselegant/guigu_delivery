<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      />
      <div class="header-content" @click="showBrief = true">
    ...
    <div class="shop-header-discounts" @click="activity = true">
    ...
    <div class="shop-brief-modal" v-show="showBrief">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="showBrief = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="activity">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li
            class="activity-item"
            :class="activity_class[support.type]"
        ...
        <div class="activity-sheet-close" @click="activity = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
...
export default {
  data() {
    return {
      activity_class: ['activity-green', 'activity-orange', 'activity-red'],
      showBrief: false,
      activity: false
    };
  },
  mounted() {
    this.$store.dispatch('req_shop_info');
  },
  computed: {
    ...mapState(['shopInfo'])
  }
...
.shop-header {
  ...
  .shop-nav {
    ...
    padding: 5px 10px;
    position: relative;
    background-image: url('https://fuss10.elemecdn.com/f/5c/ead54394c3de198d3e6d3e9111bbfpng.png'); // fuss10.elemecdn.com/f/5c/ead54394c3de198d3e6d3e9111bbfpng.png")
